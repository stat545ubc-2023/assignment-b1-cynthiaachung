...
summary_table <- function (df, categorical, numerical) 
{check <- df %>%
  pull({{numerical}}) %>%
  is.numeric
...
test_that("checks the summary_table function", {
  expect_vector(summary_table_manual, summary_table(iris, Species, Petal.Width))
